    ...
    <div class="dashboard-grid">
      <div class="main-panel">
        ...
        <div v-if="item.status === 'AT_RISK'" class="alert-box-modern">
          ...
          <button class="btn-alert-action" @click="router.push({ name: 'EditBudget', params: { id: item.id } })">
            Revisar Solicitud
          </button>
        </div>
...
.alert-box-modern { background-color: #fef2f2; border: 1px solid #fee2e2; padding: 1.5rem; border-radius: 16px; display: flex; align-items: center; gap: 1.25rem; margin-bottom: 1.5rem; }
